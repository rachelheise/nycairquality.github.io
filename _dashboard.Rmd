...
### AQI Difference from 2019 and COVID-19 Case Count
```{r plotly line plot 1, echo = F}
#plot_ly1, the overall AQI_7dayavg and NYC-wide case count
renderPlotly({
  AQI_covid_master %>% 
  mutate(
    text_label_1 = str_c("Date: ", date, "\nAQI Difference from 2019: ", round(AQI_dif, 2), "\n2020 AQI Value: ", round(AQI, 2)),
    text_label_2 = str_c("Date: ", date, "\nCOVID-19 Case Count: ", observed_value)
    ) %>% 
  ...
  plot_ly(
    ...
    layout(
      ...
      yaxis = list(side = "left", title = "AQI Difference from 2019 (7 Day Rolling Average)", showgrid = FALSE, zeroline = FALSE),
